...
#ifndef NGHK_CGAL_SKIN_SURFACE_BASE_3_H
#define NGHK_CGAL_SKIN_SURFACE_BASE_3_H
...
#include <CGAL/NGHK_Skin_surface_quadratic_surface_3.h>
...
class NGHK_Skin_surface_base_3 {
  typedef MixedComplexTraits_3                 Gt;
  typedef NGHK_Skin_surface_base_3<Gt>         Self;
...
private:
  ...
  typedef CGAL::Simple_cartesian<double>                 Filtered_kernel;
public:
  typedef NGHK_Skin_surface_quadratic_surface_3<Filtered_kernel> Quadratic_surface;
...
public:
  ...
  NGHK_Skin_surface_base_3(WP_iterator begin, WP_iterator end, FT shrink,
...
private:
  ...
  NGHK_Skin_surface_quadratic_surface_3<Traits>
  construct_surface(
    const Simplex &sim, 
...
template <class MixedComplexTraits_3> 
template < class WP_iterator >
NGHK_Skin_surface_base_3<MixedComplexTraits_3>::
NGHK_Skin_surface_base_3(WP_iterator begin, WP_iterator end, FT shrink_,
                   bool grow_balls,
...
template <class MixedComplexTraits_3>
typename NGHK_Skin_surface_base_3<MixedComplexTraits_3>::TMC &
NGHK_Skin_surface_base_3<MixedComplexTraits_3>::
triangulated_mixed_complex() {
  return _tmc;
}
...
template <class MixedComplexTraits_3> 
typename NGHK_Skin_surface_base_3<MixedComplexTraits_3>::Vector
NGHK_Skin_surface_base_3<MixedComplexTraits_3>::
normal(const Bare_point &p, 
...
construct_surface(const Simplex &sim, const Traits &) const {
  typedef NGHK_Skin_surface_quadratic_surface_3<Traits>      Quadratic_surface;
...
template <class MixedComplexTraits_3> 
typename NGHK_Skin_surface_base_3<MixedComplexTraits_3>::TMC_Cell_handle
NGHK_Skin_surface_base_3<MixedComplexTraits_3>::
...
#endif // NGHK_CGAL_SKIN_SURFACE_BASE_3_H
