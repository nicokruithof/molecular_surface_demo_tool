...
#ifndef NGHK_CGAL_SKIN_SURFACE_3_H
#define NGHK_CGAL_SKIN_SURFACE_3_H

#include <CGAL/NGHK_Skin_surface_base_3.h>
...
class NGHK_Skin_surface_3 : public NGHK_Skin_surface_base_3<MixedComplexTraits_3> {
  typedef MixedComplexTraits_3            Gt;
  typedef NGHK_Skin_surface_3<Gt>              Self;
  typedef NGHK_Skin_surface_base_3<Gt>         Base;
public:
...
public:
  ...
  NGHK_Skin_surface_3(WP_iterator begin, WP_iterator end,
                 FT shrink,
...
template <class MixedComplexTraits_3> 
template < class WP_iterator >
NGHK_Skin_surface_3<MixedComplexTraits_3>::
NGHK_Skin_surface_3(WP_iterator begin, WP_iterator end,
               FT shrink,
               bool grow_balls,
               Gt gt_,
...
#endif // NGHK_CGAL_SKIN_SURFACE_3_H
