...
#ifndef NGHK_CGAL_SKIN_SURFACE_QUADRATIC_SURFACE_H
#define NGHK_CGAL_SKIN_SURFACE_QUADRATIC_SURFACE_H

#include <CGAL/Skin_surface_traits_3.h>

extern int n_quadratic_surface_instances;

namespace CGAL {


template < class SkinSurfaceQuadraticSurfaceTraits_3 >
class NGHK_Skin_surface_quadratic_surface_3 {
public:
  ...
  NGHK_Skin_surface_quadratic_surface_3()
    : dim(-1), p(0,0,0), c(0) 
  {
    ++n_quadratic_surface_instances;
    for (int i=0; i<6; i++) Q[i] = 0;
  }
  NGHK_Skin_surface_quadratic_surface_3(FT Qinput[], Point p, FT c, int d)
    : dim(10+d), p(p), c(c)
  {
    ++n_quadratic_surface_instances;
  ...
  int dim;
  NGHK_Skin_surface_quadratic_surface_3(Weighted_point wp0, FT s)
  ...
  NGHK_Skin_surface_quadratic_surface_3(Weighted_point wp0,
				   Weighted_point wp1, 
				   FT s) : dim(1)
  {
    ++n_quadratic_surface_instances;
  ...
  static int instance_count() { return n_quadratic_surface_instances; }
...
#endif // NGHK_CGAL_SKIN_SURFACE_QUADRATIC_SURFACE_H
